...
@Component({
  selector: 'app-app-purchase-register',
  templateUrl: './app-purchase-register.component.html',
  styleUrls: ['./app-purchase-register.component.css']
})
export class AppPurchaseRegisterComponent implements OnInit {
  ...
  constructor(private localStorageService: LocalStorageService,private route: ActivatedRoute,public dialog: MatDialog,
    ...
    async ngOnInit() {
      ...
      if(this.cid != null && this.start_date != null && this.end_date != null  && this.rtype != null  && this.token != null ){
          ...
          if(this.token &&  this.cid != '' && this.start_date != '' && this.end_date != ''  && this.rtype == "purchase_register"){
            this.reportshow();
          }
          else{
