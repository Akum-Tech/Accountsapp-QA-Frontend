...
@Component({
  selector: 'app-app-cash-book',
  templateUrl: './app-cash-book.component.html',
  styleUrls: ['./app-cash-book.component.css']
})
export class AppCashBookComponent implements OnInit {
  ...
  constructor(private localStorageService: LocalStorageService,private route: ActivatedRoute,public dialog: MatDialog,
    ...
    async ngOnInit() {
      ...
      if(this.id != null && this.cid != null && this.start_date != null && this.end_date != null  && this.rtype != null  && this.token != null ){
          ...
          if(this.token &&  this.id != '' && this.cid != '' && this.start_date != '' && this.end_date != ''  && this.rtype == "cash"){
            this.reportshow();
          }
          else{
