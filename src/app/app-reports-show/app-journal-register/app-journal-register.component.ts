...
@Component({
  selector: 'app-app-journal-register',
  templateUrl: './app-journal-register.component.html',
  styleUrls: ['./app-journal-register.component.css']
})
export class AppJournalRegisterComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    if(this.cid != null && this.start_date != null && this.end_date != null  && this.rtype != null  && this.token != null ){
        ...
        if(this.token &&  this.cid != '' && this.start_date != '' && this.end_date != ''  && this.rtype == "journal_register"){
          this.reportshow();
        }
        else{
