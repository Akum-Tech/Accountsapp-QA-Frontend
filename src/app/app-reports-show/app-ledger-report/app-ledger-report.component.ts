...
@Component({
  selector: 'app-app-ledger-report',
  templateUrl: './app-ledger-report.component.html',
  styleUrls: ['./app-ledger-report.component.css']
})
export class AppLedgerReportComponent implements OnInit {
  ...
  constructor(private localStorageService: LocalStorageService,private route: ActivatedRoute,public dialog: MatDialog,
    ...
    async ngOnInit() {
      ...
      if(this.id != null && this.cid != null && this.start_date != null && this.end_date != null  && this.rtype != null  && this.token != null ){
          ...
          if(this.token &&  this.id != '' && this.cid != '' && this.start_date != '' && this.end_date != ''  && this.rtype == "ledger"){
            this.reportshow();
          }
          else{
