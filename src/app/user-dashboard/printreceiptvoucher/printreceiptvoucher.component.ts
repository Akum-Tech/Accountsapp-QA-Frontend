...
@Component({
  ...
  styleUrls: ['./printreceiptvoucher.component.css']
})
   ...
   await this.route.params.subscribe(async(params) => {
     await this.veiwreceiptService.getReceiptVoucher({voucher_id:params.uid}).subscribe(async(data) => {
      if (data === null || data === undefined) {
        ...
        console.log('receiptvoucher--------------->',data.RecieptVoucher)
        ...
        this.VoucherID = this.receiptvoucher.uid;
...
Nextvoucherprint(){
    this.salesVoucherService.NextVoucherGet({id:this.VoucherID,type:"recieptvoucher"}).subscribe(data => {
    if (data === null || data === undefined) {
      this.messagePanelService.ShowPopupMessageWithLocalization('An error occured, please try again later', this.globals.messageCloseTime, this.globals.messageType.error);
    } else if (data['success'] === true) {
        this.receiptvoucher = data.RecieptVoucher;   
...
Previousvoucherprint(){
  this.salesVoucherService.PreviousVoucherGet({id:this.VoucherID,type:"recieptvoucher"}).subscribe(data => {
    if (data === null || data === undefined) {
      this.messagePanelService.ShowPopupMessageWithLocalization('An error occured, please try again later', this.globals.messageCloseTime, this.globals.messageType.error);
    } else if (data['success'] === true) {
        this.receiptvoucher = data.RecieptVoucher;   
