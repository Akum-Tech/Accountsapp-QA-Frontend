...
@Component({
  selector: 'app-app-creditnoteprint',
  templateUrl: './app-creditnoteprint.component.html',
  styleUrls: ['./app-creditnoteprint.component.css']
})
export class AppCreditnoteprintComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    if(this.id != null && this.type != null  && this.vtype != null  && this.token != null ){
      ...
      if(this.token && this.type == "current" && this.id != '' && this.vtype == "creditvoucher"){
        this.vouchershow();
      }
      // else if(this.token && this.type == "next" && this.id != '' && this.vtype == "creditvoucher"){
      //   this.Nextvoucherprint();
      // }else if(this.token && this.type == "previos" && this.id != '' && this.vtype == "creditvoucher"){
  ...
  async vouchershow(){
    await this.appallvoucherprintService.getCrediteNoteVoucher({token:this.token,voucher_id:this.id}).subscribe(async(data) => {
      if (data === null || data === undefined) {
        this.messagePanelService.ShowPopupMessageWithLocalization('An error occured, please try again later', this.globals.messageCloseTime, this.globals.messageType.error);
      } else if (data['success'] == true) {
        this.creditVoucher = data.CreditVoucher;
        // console.log("creditVoucher --------------",this.creditVoucher)
        // this.id = this.creditVoucher.uid;
