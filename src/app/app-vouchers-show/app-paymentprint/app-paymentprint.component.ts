...
@Component({
  selector: 'app-app-paymentprint',
  templateUrl: './app-paymentprint.component.html',
  styleUrls: ['./app-paymentprint.component.css']
})
export class AppPaymentprintComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    if(this.id != null && this.type != null  && this.vtype != null  && this.token != null ){
      ...
      if(this.token && this.type == "current" && this.id != '' && this.vtype == "paymentvoucher"){
        this.vouchershow();
      }
      // else if(this.token && this.type == "next" && this.id != '' && this.vtype == "paymentvoucher"){
      //   this.Nextvoucherprint();
      // }else if(this.token && this.type == "previos" && this.id != '' && this.vtype == "paymentvoucher"){
  ...
  async vouchershow(){
    await this.appallvoucherprintService.GetpaymentVoucher({token:this.token,voucher_id:this.id}).subscribe(async(data) => {
