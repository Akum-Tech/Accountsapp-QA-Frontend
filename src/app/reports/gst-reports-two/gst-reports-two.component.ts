...
@Component({
  selector: 'app-gst-reports-two',
  templateUrl: './gst-reports-two.component.html',
  styleUrls: ['./gst-reports-two.component.css']
})
export class GstReportsTwoComponent implements OnInit {
  ...
  async gstreportshowsummary(){
    ...
    this.reportLedgerService.gstronereportssummarytwo(this.gstreport).subscribe(async data => {
