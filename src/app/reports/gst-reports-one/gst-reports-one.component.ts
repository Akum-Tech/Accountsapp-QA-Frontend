...
@Component({
  selector: 'app-gst-reports-one',
  templateUrl: './gst-reports-one.component.html',
  styleUrls: ['./gst-reports-one.component.css']
})
export class GstReportsOneComponent implements OnInit {
  ...
  async gstreportshow(){
    ...
    this.reportLedgerService.gstronereports(this.gstreport).subscribe(async data => {
      if (data === null || data === undefined) {
          this.messagePanelService.ShowPopupMessageWithLocalization('An error occured, please try again later', this.globals.messageCloseTime, this.globals.messageType.error);
        } else if (data['success'] == true) {

          this.gstreportList = data.Voucher;
          this.loader = false;
  ...
  async gstreportshowsummary(){
    ...
    this.reportLedgerService.gstronereportssummary(this.gstreport).subscribe(async data => {
      if (data === null || data === undefined) {
          this.messagePanelService.ShowPopupMessageWithLocalization('An error occured, please try again later', this.globals.messageCloseTime, this.globals.messageType.error);
        } else if (data['success'] == true) {

          this.gstrlist = data.data;
  ...
  DownLoadExcel(){
    this.reportLedgerService.gstronereports(this.gstreport).subscribe(data =>{this.downloadFile(data)});
  }
