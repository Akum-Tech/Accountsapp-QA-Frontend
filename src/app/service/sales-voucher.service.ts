...
export class SalesVoucherService {
  ...
  salesVoucher(body): Observable<any> {
    let endpoint = 'api/saleVoucher';
  ...
  LastDate(body): Observable<any> {
    let endpoint = 'api/saleVoucher/lastdate';
    return this.http.post<any>(this.apiUrl + endpoint,body, this.getHeader())
      .pipe(map(res => JSON.parse(res)), catchError(err => this.handleError(err)));
  }
  
  getSalesVoucher(body): Observable<any> {
    let endpoint = 'api/saleVoucher/all';
    return this.http.post<any>(this.apiUrl + endpoint, body, this.getHeader())
      .pipe(map(res => JSON.parse(res)), catchError(err => this.handleError(err)));
  }
  ...
  editsalesVoucher(body): Observable<any> {
    let endpoint = 'api/saleVoucher/'+body.uid;
    return this.http.put<any>(this.apiUrl + endpoint,body, this.getHeader())
      .pipe(map(res => JSON.parse(res)), catchError(err => this.handleError(err)));
  }
  
  cancelsalesVoucher(body): Observable<any> {
    let endpoint = 'api/saleVoucher/cancel/'+body.uid;
    return this.http.put<any>(this.apiUrl + endpoint,body, this.getHeader())
      .pipe(map(res => JSON.parse(res)), catchError(err => this.handleError(err)));
  }

  deletesalesVoucher(body): Observable<any> {
    let endpoint = 'api/saleVoucher/'+body.uid;
