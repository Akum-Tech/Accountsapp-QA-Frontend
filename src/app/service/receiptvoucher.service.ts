...
export class ReceiptvoucherService {
  ...
  CreateReceiptVoucher(body): Observable<any> {
    let endpoint = 'api/recieptVoucher';
  ...
  //   let endpoint = 'api/recieptVoucher/all';
  ...
  LastDate(body): Observable<any> {
    let endpoint = 'api/recieptVoucher/lastdate';
    return this.http.post<any>(this.apiUrl + endpoint,body, this.getHeader())
      .pipe(map(res => JSON.parse(res)), catchError(err => this.handleError(err)));
  }
  ...
  editReceiptVoucher(body): Observable<any> {
    let endpoint = 'api/recieptVoucher/'+body.uid;
    return this.http.put<any>(this.apiUrl + endpoint,body, this.getHeader())
      .pipe(map(res => JSON.parse(res)), catchError(err => this.handleError(err)));
  }

  cancelVoucher(body): Observable<any> {
    let endpoint = 'api/recieptVoucher/cancel/'+body.uid;
    return this.http.put<any>(this.apiUrl + endpoint,body, this.getHeader())
      .pipe(map(res => JSON.parse(res)), catchError(err => this.handleError(err)));
  }
