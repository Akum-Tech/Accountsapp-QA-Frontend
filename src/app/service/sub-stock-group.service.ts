...
export class SubStockGroupService {
  ...
  substockgroup(body): Observable<any> {
    let endpoint = 'api/substockGroup';
  ...
  getsubstockgroup(body): Observable<any> {
    let endpoint = 'api/substockGroup/all';
  ...
  putsubstockgroup(id,body): Observable<any> {
    let endpoint = 'api/substockGroup/'+id;
    return this.http.put<any>(this.apiUrl + endpoint,body,this.getHeader())
      .pipe(map(res => JSON.parse(res)), catchError(err => this.handleError(err)));
  }
  deletesubStockGroup(body): Observable<any> {
    let endpoint = 'api/substockGroup/'+body.uid;
    return this.http.delete<any>(this.apiUrl + endpoint, this.getHeader())
      .pipe(map(res => JSON.parse(res)), catchError(err => this.handleError(err)));
  }
  getstockgroup(body): Observable<any> {
    let endpoint = 'api/stockGroup/all';
    let params: any = {'company_id': body.company_id};
    return this.http.get<any>(this.apiUrl + endpoint, this.getHeaderwithParams(params))
      .pipe(map(res => JSON.parse(res)), catchError(err => this.handleError(err)));
  }
